...
const clientId = "BIbOPTHvKSyeu-OnFNp6TID_Aee1LjLO_2WxLXZ3IKa8ud4buuoJZimCRuIMRrzOkFW4Lhrl0uiJ54SxDp3lfHU"; // get from https://dashboard.web3auth.io
  ...
  useEffect(() => {
    const init = async () => {
      ...
      const web3auth = new Web3AuthCore({
        clientId: "BIbOPTHvKSyeu-OnFNp6TID_Aee1LjLO_2WxLXZ3IKa8ud4buuoJZimCRuIMRrzOkFW4Lhrl0uiJ54SxDp3lfHU",
        chainConfig: {
      ...
      const openloginAdapter = new OpenloginAdapter({
        adapterSettings: {
          network: "testnet",
          clientId: "BIbOPTHvKSyeu-OnFNp6TID_Aee1LjLO_2WxLXZ3IKa8ud4buuoJZimCRuIMRrzOkFW4Lhrl0uiJ54SxDp3lfHU", //Optional - Provide only if you haven't provided it in the Web3Auth Instantiation Code
          uxMode: "redirect", 
          whiteLabel: {
            name: "BlumontWallet",
          ...
          loginConfig: {
            ...
            jwt: {
              ...
              clientId: "BIbOPTHvKSyeu-OnFNp6TID_Aee1LjLO_2WxLXZ3IKa8ud4buuoJZimCRuIMRrzOkFW4Lhrl0uiJ54SxDp3lfHU", // Pass on the clientId of the login provider here - Please note this differs from the Web3Auth ClientID. This is the JWT Client ID
            },
          },
        },
      });
